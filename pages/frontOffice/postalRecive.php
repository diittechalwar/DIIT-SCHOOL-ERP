                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                               ...
                                               <td>1</td> 
                                                ...
                                                <td>Flip School</td>
                                                <td>12/05/2018</td> 
                                                <td class="table-data pr-0"> <button type="button"  data-toggle="modal" data-target="#details" title="Details" class="btn btn-outline-secondary btn-sm ml-2"><span class="ti-align-justify"></span></button> 
                                                <a href="<?php echo BASE_URL ."pages/frontOffice/editPostalRecive.php" ?>"><button type="button" title="Edit"  class="btn btn-outline-primary btn-sm  ml-2"><span class="ti-pencil-alt"></span></button></a>
