                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                               ...
                                               <td>Complaint</td>
                                                ...
                                                <td>1:15 PM</td>
                                                <td>12:20 AM</td> 
                                                <td class="table-data">  <button type="button" title="Details"  data-toggle="modal" data-target="#details" class="btn btn-outline-secondary btn-sm  ml-2"><span class="ti-align-justify"></span></button> 
                                                     <a href="<?php echo BASE_URL ."pages/frontOffice/EditvisitorBooks.php" ?>"><button type="button" title="Edit" class="btn btn-outline-primary btn-sm  ml-2"><span class="ti-pencil-alt"></span></button></a>
                                                     <button type="button"  class="btn btn-outline-danger  btn-sm ml-2" title="Delete"><span class="ti-trash"></span></button> </td>
                                               </tr>
                                            </tbody>
                                        </table>
                                    </div>
