                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                               ...
                                               <td>1</td> 
                                                ...
                                                <td>Flip School</td>
                                                <td>12/05/2018</td> 
                                                <td class="pr-0"> <button type="button"  data-toggle="modal" title="Details"  data-target="#details" class="btn btn-outline-secondary btn-sm float-left ml-2"><span class="ti-align-justify"></span></button> 
                                                <a href="<?php echo BASE_URL ."pages/frontOffice/editPostalDispatch.php" ?>"><button type="button" title="Edit"  class="btn btn-outline-primary btn-sm  float-left ml-2"><span class="ti-pencil-alt"></span></button></a>
