            ...
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class=" menu-icon fa fa-bandcamp mr-1"></i> Front Office  /   Add Postal Recive </h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row"> 
                               ...
                               <div class="col-md-12 form-group">
                                 ...
                                 <textarea name="" id="" cols="30" rows="2" class="form-control-sm form-control"></textarea>
                               </div>
                               <div class="col-md-12 form-group">
                               ...
                               <div class="col-md-12 form-group">
                                   ...
                                   <input type="text" name="" id="" class="form-control-sm form-control">
                               </div>
                               <div class="col-md-12 form-group">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                               ...
                                               <td>1</td> 
                                                ...
                                                <td>Flip School</td>
                                                <td>12/05/2018</td> 
                                                <td class="table-data pr-0"> <button type="button"  data-toggle="modal" data-target="#details" class="btn btn-outline-secondary btn-sm ml-2" title="Details"><span class="ti-align-justify"></span></button> 
                                                <a href="<?php echo BASE_URL ."pages/frontOffice/editPostalRecive.php" ?>"><button type="button"  class="btn btn-outline-primary btn-sm  ml-2" title="Edit"><span class="ti-pencil-alt"></span></button></a>
