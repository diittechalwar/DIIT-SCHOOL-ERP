                ...
                <div class="col-sm-12">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><i class="ti-user mr-1"></i> Student Information /  Student Admission</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group ">
                                    ...
                                    <a class="btn btn-secondary btn-sm color-white" href="" data-toggle="modal" data-target="#staticModal3"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
