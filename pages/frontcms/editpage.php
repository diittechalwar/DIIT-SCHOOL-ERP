                ...
                <div class="col-sm-12">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><i class="fa fa-empire mr-1" aria-hidden="true"></i> Front CMS / Edit Pages</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <span class="card-title" v-if="headerText"> Edit Pages</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row ml-1">
                                <div class="form-group">
                                    <label class="pr20">Page Type :-</label><br>
                                    <label class="radio-inline">
                                    <input type="radio" value="standard" name="content_category" checked="checked"> Standard </label><br>
                                    <label class="radio-inline">
                                    <input type="radio" value="events" name="content_category"> Events </label><br>
                                    <label class="radio-inline">
                                    <input type="radio" value="notice" name="content_category"> News </label><br>
                                    <label class="radio-inline">
                                    <input type="radio" value="gallery" name="content_category"> Gallery </label><br>
                                </div>
                            </div>
                            <div class="form-group">
