                ...
                <div class="col-sm-12">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><i class="fa fa-newspaper-o mr-1" aria-hidden="true"></i> Certificate / Edit Student Id Card</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <span class="card-title" v-if="headerText"> Edit Student Id Card</span>
                        </div>
                        <div class="card-body">
