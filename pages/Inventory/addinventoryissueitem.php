                ...
                <div class="col-sm-12">
                    <div class="page-header d-inline-block">
                        <div class="page-title">
                            <h1><i class="ti-layers mr-1"></i> Inventory / Add Issue Item</h1>
                        </div>
                    </div>
        ...
        <div class="animated">
            <div class="card">
                <div class="card-header">
                    <span>Add Inventory Issue Item</span>
                </div>
                <div class="card-body">
                <form action="" method="post">
                        ...
                        <div class="form-actions ">
                            <button type="submit" class="btn btn-secondary mt-2 btn-sm float-right">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
