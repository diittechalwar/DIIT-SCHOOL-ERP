                ...
                <div class="col-sm-12">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><i class="menu-icon fa fa-cogs mr-1"></i> Human Resource / Designation</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-stats order-table table-responsive">
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            <th class="serial">Designation <i class="fa fa-caret-down" aria-hidden="true"></i></th>
                                            <th class="avatar">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="alert with-close">
                                            <td class="serial">Teacher 1</td>
                                            <td class="pr-0"><a href="editdesignation.php" title="edit" class="btn btn-outline-primary btn-sm mr-2"><i class="fa fa-pencil-square-o " aria-hidden="true"></i></a>
