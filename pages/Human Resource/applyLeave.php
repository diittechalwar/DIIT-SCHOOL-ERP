                ...
                <div class="col-sm-12">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><i class="menu-icon fa fa-cogs mr-1"></i> Human Resource / Apply Leave</h1>
                        </div>

                    </div>
                    <button data-toggle="modal" data-target="#staticModal5" class="btn btn-secondary btn-sm float-right mt-2">Apply Leave</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <form action="#">
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-4">
                                <label>Reason</label>
                                <br>
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="#" data-toggle="modal" class="btn btn-outline-secondary btn-sm" data-target="#staticModal4"><i class="fa fa-align-justify" aria-hidden="true"></i></a></td>
                                </tr>
