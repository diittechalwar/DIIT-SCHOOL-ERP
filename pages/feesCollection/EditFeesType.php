            ...
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class=" menu-icon fa fa-money mr-1"></i>  Fees Collection  / Add Fees Type</h1>
                    </div>
                </div>
            </div>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                               ...
                                               <td>1</td>    
                                                <td>School Fees</td> 
                                                <td>Adm </td> 
                                                <td class=" ">  <a href="<?php echo BASE_URL ."pages/feesCollection/EditFeesType.php" ?>"><button type="button"  class="btn btn-outline-primary btn-sm ml-2"><span class="ti-pencil-alt"></span></button></a>
